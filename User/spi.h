...
//**************宏定义********************///
//NRF24L01寄存器操作命令
#define R_REG        0x00  //读配置寄存器,低5位为寄存器地址
#define W_REG       0x20  //写配置寄存器,低5位为寄存器地址
